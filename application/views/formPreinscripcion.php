...
<?= form_open("Preinscripcion") ?>
<label>Cédula*:</label><br>
<input type="number" name="cedula" value="<?= set_value("cedula") ?>" required><br>

<label>Código Uniminuto*:</label><br>
<input type="number" name="codigo" value="<?= set_value("codigo") ?>" required><br>
...
<input type="number" name="" value="<?= set_value("telefono") ?>"><br>

<label>Celular:</label><br>
<input type="number" name="celular" value="<?= set_value("celular") ?>"><br>
...
<script>
    $("#facultad").change(function() {
        ...
        if (valor !== "") {
            $.ajax({
                url: $("form").attr("action") + "/traerPrograma/" + valor,
                type: "POST",
                dataType: "json",
